...
export default function Header({ onMenuClick }) {
  ...
  return <header className="sticky top-4 z-30 mb-6 rounded-2xl border border-brand-border/80 bg-white/90 p-3 shadow-card backdrop-blur md:p-4">
    <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <h2 className="mt-1 text-xl font-black text-brand-primary">Business Workspace</h2>
        </div>
      </div>

      <div className="flex flex-col gap-3 md:flex-row md:items-center">
        <div className="flex min-w-0 items-center gap-2 rounded-xl border border-brand-border bg-brand-soft/70 px-3 py-2 text-sm text-brand-muted md:w-72">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-brand-border bg-white px-3 py-2">
        ...
        <Button variant="outline" onClick={signOut} className="flex items-center justify-center gap-2 px-3 py-2.5"><LogOut size={17} />Logout</Button>
      </div>
    </div>
  </header>;
}
