  ...
  return <Routes>
    ...
    <Route path="/*" element={<ProtectedLayout>
      <Routes>
        ...
        <Route path="/project-plans" element={<Navigate to="/projects" replace />} />
        <Route path="/project-plans/add" element={<Navigate to="/projects/add" replace />} />
        <Route path="/project-plans/:projectId/edit" element={<Navigate to="/projects" replace />} />
