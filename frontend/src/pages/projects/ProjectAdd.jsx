...
export default function ProjectAdd() {
  ...
  return <div className="space-y-6">
    ...
    <Card className="p-5 md:p-6">
      ...
      <p className="mt-1 text-sm text-brand-muted">Create the project first. Payment plans, client payments, and expenses can be managed later from the Projects menu.</p>
      ...
      <form onSubmit={handleSubmit} className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-brand-border p-4">
          <div className="mb-3 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div><h3 className="font-bold text-brand-primary">Employee Assignment</h3><p className="text-sm text-brand-muted">Optional. Payment plans are not required during project creation.</p></div>
        ...
        <div className="lg:col-span-2"><FormField label="Notes"><textarea name="notes" value={form.notes} onChange={updateField} placeholder="Contract notes, scope, or project remarks..." className={`${fieldInputClass} min-h-28 resize-y`} /></FormField></div>
