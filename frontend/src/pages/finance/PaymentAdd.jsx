...
import { getClients, getInvoices, getProjects, getSuppliers, isClientPayment, isSupplierPayment } from "../../services/api";
...
export default function PaymentAdd() {
  ...
  return <div className="space-y-6">
    <FinanceHeader
      title="Add Payment"
      description="Record client receipts or supplier payouts against projects and invoices."
      backTo="/payments"
