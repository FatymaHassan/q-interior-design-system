...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/employees', [HrController::class, 'employees'])->middleware('role:admin,manager,hr');
    ...
    Route::post('/payrolls/generate', [HrController::class, 'generatePayroll'])->middleware('role:admin,manager,hr');
    Route::post('/payrolls/{payroll}/approve', [HrController::class, 'approvePayroll'])->middleware('role:admin,manager');
