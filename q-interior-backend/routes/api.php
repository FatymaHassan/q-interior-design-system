...
use App\Http\Controllers\Api\ProjectPaymentStageController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/projects/{project}/payment-stages', [ProjectPaymentStageController::class, 'index'])->middleware('role:admin,manager,finance');
    Route::post('/projects/{project}/payment-stages', [ProjectPaymentStageController::class, 'store'])->middleware('role:admin,manager,finance');
    Route::put('/project-payment-stages/{projectPaymentStage}', [ProjectPaymentStageController::class, 'update'])->middleware('role:admin,manager,finance');
    Route::patch('/project-payment-stages/{projectPaymentStage}', [ProjectPaymentStageController::class, 'update'])->middleware('role:admin,manager,finance');
    Route::delete('/project-payment-stages/{projectPaymentStage}', [ProjectPaymentStageController::class, 'destroy'])->middleware('role:admin,manager,finance');
